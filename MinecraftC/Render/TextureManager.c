...
int TextureManagerLoad(TextureManager * manager, char * resource) {
	...
	for (int i = 0; i < ListLength(manager->textureNames); i++) {
		if (strcmp(manager->textureNames[i], resource) == 0) {
			loaded = true;
			index = i;
		}
	}
	...
	uint8_t * p = NULL;
	if (strcmp(resource, "Clouds.png") == 0) { p = (uint8_t *)Resource_Clouds_RGBA; width = Resource_Clouds_Width; height = Resource_Clouds_Height; }
	if (strcmp(resource, "Default.png") == 0) { p = (uint8_t *)Resource_Default_RGBA; width = Resource_Default_Width; height = Resource_Default_Height; }
	if (strcmp(resource, "Dirt.png") == 0) { p = (uint8_t *)Resource_Dirt_RGBA; width = Resource_Dirt_Width; height = Resource_Dirt_Height; }
	if (strcmp(resource, "Particles.png") == 0) { p = (uint8_t *)Resource_Particles_RGBA; width = Resource_Particles_Width; height = Resource_Particles_Height; }
	if (strcmp(resource, "Rain.png") == 0) { p = (uint8_t *)Resource_Rain_RGBA; width = Resource_Rain_Width; height = Resource_Rain_Height; }
	if (strcmp(resource, "Rock.png") == 0) { p = (uint8_t *)Resource_Rock_RGBA; width = Resource_Rock_Width; height = Resource_Rock_Height; }
	if (strcmp(resource, "Terrain.png") == 0) { p = (uint8_t *)Resource_Terrain_RGBA; width = Resource_Terrain_Width; height = Resource_Terrain_Height; }
	if (strcmp(resource, "Water.png") == 0) { p = (uint8_t *)Resource_Water_RGBA; width = Resource_Water_Width; height = Resource_Water_Height; }
	if (strcmp(resource, "GUI/GUI.png") == 0) { p = (uint8_t *)Resource_GUI_GUI_RGBA; width = Resource_GUI_GUI_Width; height = Resource_GUI_GUI_Height; }
	if (strcmp(resource, "GUI/Icons.png") == 0) { p = (uint8_t *)Resource_GUI_Icons_RGBA; width = Resource_GUI_Icons_Width; height = Resource_GUI_Icons_Height; }
